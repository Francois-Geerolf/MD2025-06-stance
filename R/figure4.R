...
write_csv(figure4, "csv/figure4.csv")
ggsave("png/figure4.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("pdf/figure4.pdf", width = 1.25*6, height = 1.25*3.375)
...
write_csv(figure4_fr, "csv/figure4_fr.csv")
ggsave("png/figure4_fr.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("pdf/figure4_fr.pdf", width = 1.25*6, height = 1.25*3.375)
