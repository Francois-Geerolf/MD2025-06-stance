...
write_csv(figure7, "csv/figure7.csv")
ggsave("png/figure7.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("pdf/figure7.pdf", width = 1.25*6, height = 1.25*3.375)
...
write_csv(figure7_fr, "csv/figure7_fr.csv")
ggsave("png/figure7_fr.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("pdf/figure7_fr.pdf", width = 1.25*6, height = 1.25*3.375)
