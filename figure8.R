...
write_csv(figure8, "figure8.csv")
ggsave("figure8.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("figure8.pdf", width = 1.25*6, height = 1.25*3.375)
...
write_csv(figure8_fr, "figure8_fr.csv")
ggsave("figure8_fr.png", width = 1.25*6, height = 1.25*3.375, bg = "white")
ggsave("figure8_fr.pdf", width = 1.25*6, height = 1.25*3.375)
